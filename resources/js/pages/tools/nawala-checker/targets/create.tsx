...
export default function CreateTarget({ groups, tags }: CreateTargetProps) {
    ...
    return (
        <>
            <Head title="Add Target - Nawala Checker" />
            ...
            <div className="min-h-screen bg-gray-100 py-6">
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-6">
                        ...
                        <h1 className="text-3xl font-bold text-gray-900">Add New Target</h1>
                        <p className="mt-2 text-sm text-gray-600">
                            Add a new domain or URL to monitor
                        </p>
                    </div>
