...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('nc_shortlinks', function (Blueprint $table) {
            ...
            $table->foreignId('current_target_id')->nullable()->constrained('nc_shortlink_targets')->nullOnDelete();
            $table->foreignId('original_target_id')->nullable()->constrained('nc_shortlink_targets')->nullOnDelete();
            $table->boolean('is_active')->default(true);
